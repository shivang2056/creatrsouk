...
class ReviewsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create review" do
    assert_difference('Review.count') do
      post user_purchase_reviews_url(@user_purchase2), params: { review: { rating: 5, comment: "Test Comment" } }
    end
  ...
  test "should not create review with invalid params" do
    assert_no_difference('Review.count') do
      post user_purchase_reviews_url(@user_purchase2), params: { review: { rating: nil } }
    end
  ...
  test "should get edit" do
    get edit_user_purchase_review_url(@user_purchase1, @review)

    assert_response :success
  end

  test "should update review" do
    patch user_purchase_review_url(@user_purchase1, @review), params: { review: { comment: "New test comment" } }
  ...
  test "should not update review with invalid params" do
    patch user_purchase_review_url(@user_purchase1, @review), params: { review: { rating: nil, comment: nil } }
